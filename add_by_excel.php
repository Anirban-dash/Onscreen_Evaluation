...
<div class="container-fluid ">
    ...
    <form method="POST" action="excelUpload.php" enctype="multipart/form-data" class="mt-2">
  ...
  <p class="text-warning">*Excel should be in proper format like</p>
  <a href="test.xlsx" download>this</a>
</form>
    </div>
    </div>
