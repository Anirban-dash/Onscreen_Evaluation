...
<div class="container-fluid ">
    ...
    <form action="student_submit.php" method="post" class="mt-2">
  <div class="form-row">
  ...
  <div class="form-group">
    <label for="inputAddress1">Branch</label>
    <input type="text" name="branch" class="form-control" id="inputAddress1" required>
  </div>
  <button type="submit" class="btn btn-info btn-block mb-2">Add</button>
</form>
    </div>
    </div>
